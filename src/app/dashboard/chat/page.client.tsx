...
export default function ChatPage() {
  ...
  return (
    <Fragment>
      ...
      />
      <DashboardGutter className="!p-0 !gap-0 flex flex-col h-lvh">
            ...
            <div className="flex flex-col items-center justify-center h-full px-4">
              <div className="text-center mb-8 max-w-2xl">
                ...
                <p className="text-muted-foreground mb-8">
                  I can help you analyze job postings, create proposal
                  structures, improve existing proposals, and develop pricing
                  strategies.
                </p>
              </div>
        ...
        <div className="w-full shrink-0 px-4 py-4 bg-background border-t sticky bottom-0">
