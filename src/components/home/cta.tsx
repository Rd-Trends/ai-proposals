  ...
  return (
    <Section className="py-20 relative overflow-x-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center">
        <div className="p-8 md:p-12 lg:p-16 rounded-3xl border bg-card/50 backdrop-blur-sm relative overflow-hidden">
          ...
          <p className="text-base md:text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            ...
            AI-powered proposals. Start creating winning proposals today—no
