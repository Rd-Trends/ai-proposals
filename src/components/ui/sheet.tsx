    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        className={cn(
          ...
          side === "bottom" &&
            "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom inset-x-0 md:inset-x-1 bottom-0 h-auto max-h-[calc(100vh-2rem)] border-t rounded-t-2xl",
          className
        )}
