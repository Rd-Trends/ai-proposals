[x] - make chat persistent
[x] - add pagination, enure it's responsive on mobile
[x] - refactor chat component
[] - Build home page
    [x] Hero Section (Already implemented)
    [x] Features Section - Showcase key features (AI generation, templates, tracking, etc.)
    [x] How It Works section 
    [x] Benefits/Problem-Solution - Address freelancer pain points
